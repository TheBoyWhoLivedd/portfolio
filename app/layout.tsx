...
export const metadata = {
  title: "Ronnie Ayesigwa | Full-Stack & Applied AI Engineer",
  description:
    "Portfolio of Ronnie Ayesigwa, a full-stack and applied AI engineer building production SaaS, mobile systems, and reliable AI agents.",
};
